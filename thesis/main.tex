...
\bottomrule
\multicolumn{6}{l}{$^\ddagger$FIFO computed from direct cold-start measurements (90.3s/switch average); equivalent full-scale runtime $\approx$2.5--12.6h. $^\dagger$Projected from $C(n)$ equations; SA from $C_{SA}(n)\approx129+0.071n$.} \\
\end{tabular}
\normalsize
\end{table}
