...
Table~\ref{tab:exp4_sensitivity} shows the measured results. At $n=5$, the JR ordering (0.6B$\to$32B$\to$8B) achieves 135.8\,$\pm$\,3.0s, ranking 2nd; the empirically fastest ordering (0.6B$\to$8B$\to$32B, 131.1\,$\pm$\,2.2s) is 4.7s ahead, within the $\pm$2.2--3.0s noise range and therefore statistically indistinguishable. At $n=15$, the two 0.6B-first orderings measure 137.9\,$\pm$\,5.8s and 145.2\,$\pm$\,11.6s respectively, a 7.3s gap consistent with a transition towards the all-S1 regime. At $n=30$, all groups become S1, the gap between the two 0.6B-first orderings collapses to 0.5s, and the JR ordering (0.6B$\to$8B$\to$32B) achieves rank~1/6 (Table~\ref{tab:exp4_ordering_results}).
