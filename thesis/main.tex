...
\caption{Incremental scheduling strategy ablation for 501 tasks with 3 models (0.6B, 8B, 32B). FIFO (measured extrapolation, $\approx$12.6h) is shown on a separate axis. Each column adds one optimisation component.}
\label{fig:exp1_bar}
\end{figure}
