...
The project contributed approximately 8,000 lines of new Python code to the existing ServerlessLLM framework ($\sim$15K LoC), with additional benchmark scripts and unit tests on top of that. Evaluation shows the shared-aware strategy achieves a 276$\times$ speedup over FIFO for a 501-task batch (164.7\,s versus an extrapolated 45,495\,s), with speedup growing as batch size increases.
